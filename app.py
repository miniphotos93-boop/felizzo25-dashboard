...
# Admin users list
ADMINS = ['sharikan', 'abirajad', 'ramybabu', 'rammaka', 'saktgane', 'abhavara', 'jdpu', 'suhmohan', 'mutnur', 'kuthal', 'lavys', 'nsym', 'dillibab', 'rajeswj', 'selsel', 'mirunas']  # Add admin usernames here
